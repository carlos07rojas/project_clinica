...
public class HistorialClinicoService {
    ...
    public HistorialClinicoResponseDTO crearHistorial(HistorialClinicoRequestDTO dto) {
        ...
        // no puede existir un historial para esa cita. Cada cita genera solo un
        // historial medico
    ...
    public List<HistorialClinicoResponseDTO> obtenerPorPaciente(Integer idPaciente) {
        // devuelve todas las consultas que tuvo el paciente con sus diagnósticos y
        // tratamientos
        return historialClinicoRepository.findHistorialPorPaciente(idPaciente).stream().map(this::convertirAResponseDTO)
                .collect(Collectors.toList());
    }

    public HistorialClinicoResponseDTO editarHistorial(Integer id, HistorialClinicoEditarDTO dto) {
        ...
        return convertirAResponseDTO(historialClinicoRepository.save(historial));
    }
