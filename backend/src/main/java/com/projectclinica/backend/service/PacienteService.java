...
public class PacienteService {
    ...
    public PacienteResponseDTO crearPaciente(PacienteRequestDTO dto) {
        ...
        // el usuario ya debe de tener un perfil de paciente por eso la relacion de USUARIO-PACIENTe 1 a 1.
    ...
    private PacienteResponseDTO convertirAResponseDTO(Paciente p) {
        ...
        // se incluye nombre y email del usuario para mostrar en el frontend sin hacer otra consulta
