...
public interface UsuarioRepository
        // Jpa hace dos cosas primero que este Repository trabaja con la clase Usuario.
        // Segundo que el tipo de dato de su clave primaria es Integer
        extends JpaRepository<Usuario, Integer> {
    // "Optional" representa un valor que puede existir o no | campo unico
    // "findBy" esto representa de una manera mas simplicada que es una busqueda, es
    // una representacion mas corta de una consulta SQL "Email" representa el campo
    // que se busca
    ...
    // verifica si existe un email para editar
    boolean existsByEmailAndIdUsuarioNot(
            String email, Integer idUsuario);
