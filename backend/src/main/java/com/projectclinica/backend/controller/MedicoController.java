...
public class MedicoController {
    ...
    // public ResponseEntity<List<MedicoResponseDTO>>
    // obtenerPorEspecialidad(@RequestParam Integer idEspecialidad) {
    // return
    // ResponseEntity.ok(medicoService.obtenerPorEspecialidad(idEspecialidad));
    // }

    @PatchMapping("/{id}/editar")
    public ResponseEntity<MedicoResponseDTO> editar(@PathVariable Integer id, @RequestBody MedicoEditarDTO dto) {
        return ResponseEntity.ok(medicoService.editarMedico(id, dto));
    }
}
